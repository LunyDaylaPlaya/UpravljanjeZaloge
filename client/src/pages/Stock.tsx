                    ...
                    {filteredData.map((record, index) => {
                        ...
                        return (
                            <tr key={record.id}>
                                ...
                                <td>{record.unit}</td>
                                <td>
                                    {new Intl.NumberFormat("sl-SI", { notation: "standard", compactDisplay: "short" }).format(getProductPriceById(record.productId))}
                                </td>
                                <td>
                                    {new Intl.NumberFormat("sl-SI", { notation: "standard", compactDisplay: "short" }).format(getProductPriceById(record.productId) * record.quantity)}
                                </td>
                                <td>
